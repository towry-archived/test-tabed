...
//  test-tabed
//
//  Created by towry on 15/02/2017.
//  Copyright © 2017 towry. All rights reserved.
//

import UIKit

protocol ViewControllerSwitchDelegate: NSObjectProtocol {
    func subViewButtonClicked() -> Void
}
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        self.window?.accessibilityIdentifier = "MainWindow"
